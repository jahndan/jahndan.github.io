...
#html.small[
  ...
  elements of $S$, so that $(S^plus.minus, times)$ may be a multiplicative
  group.
]
...
#table(
  ...
  sym.crossmark, sym.checkmark, sym.checkmark, sym.checkmark,

  table.cell(colspan: 4, none),

  $(ZZ, times)$, $(QQ, times)$, $(RR, times)$, $(CC, times)$,
  sym.crossmark, sym.crossmark, sym.crossmark, sym.crossmark,
